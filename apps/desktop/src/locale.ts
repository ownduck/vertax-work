...
export const en = {
  ...
  startupFailed: 'Vertax Work is unavailable',
  ...
  updateDownloadedTitle: 'Vertax Work v{version} downloaded',
...
export const zh = {
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Vertax Work 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Vertax Work v{version} 下载完成',
