...
export const en = {
  ...
  startupFailed: 'Vertax Work could not start',
  startupLoading: 'Starting Vertax Work…',
...
export const zh = {
  application: '应用',
  startupFailed: 'Vertax Work 无法启动',
  startupLoading: '正在启动 Vertax Work…',
  ...
  pluginWindowTitle: 'Vertax Work — 桌面插件',
