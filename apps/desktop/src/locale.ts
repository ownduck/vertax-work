...
export const en = {
  ...
  startupFailed: 'Vertaw Work is unavailable',
  ...
  updateDownloadedTitle: 'Vertaw Work v{version} downloaded',
...
export const zh = {
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Vertaw Work 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Vertaw Work v{version} 下载完成',
